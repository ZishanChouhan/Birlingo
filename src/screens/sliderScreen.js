...
export default class AppIntroSlider extends React.Component {
    ...
    _renderNextButton = () => this.props.screenName == "AppInfo" ? this._renderButton('Next', this._onNextPress) : this._renderIcon("next", "caretright", this._onNextPress);

    _renderPrevButton = () => this.props.screenName == "AppInfo" ? this._renderButton('Prev', this._onPrevPress) : this._renderIcon("prev", "caretleft", this._onPrevPress);
